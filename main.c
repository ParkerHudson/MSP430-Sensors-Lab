...
#define YELLOW_LED      BIT4    // P1.4     // light sensor

#define GREEN_LED       BIT5    // P1.5     // temperature sensor

#define RED_LED         BIT0    // P2.0     // touch sensor
...

{
    ...
    P1DIR |= ( YELLOW_LED | GREEN_LED | BIT6);             // set bits 4, 5, 6 as outputs

    P2DIR |=   RED_LED;                            // set bit  0       as outputs
...

    {
            ...
            if(light < lightroom * 1.50 && light > lightroom * 1.20)
            {
            ...
            {   if(light >= lightroom * 1.50) {P1OUT |=  YELLOW_LED; __delay_cycles(200);}    // on if dark

                if(light <= lightroom * 1.20) {P1OUT &= ~YELLOW_LED; __delay_cycles(200);}    // off if light
    ...
    // beginning of area for all students changes
...

            {
                ...
                //if(touch >= touchroom * 0.9) {P2OUT ^= RED_LED; __delay_cycles(200);}  // off
